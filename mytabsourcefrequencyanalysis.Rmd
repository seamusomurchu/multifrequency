...
for i, rep in enumerate(outreps):
    print(i, rep, outreps[i])
    aziA[i, :], ziA[i, :] = AbberatedCut(np.array(data['Xpos']), np.array(data['Ypos']), freqint[i, :], 
...
for i, rep in enumerate(outreps):
    #print(rep)
    plt.plot(aziA[i,:], ziA[i,:], '', label=str(freqs[i])+' GHz', lw=3)
...
for i, rep in enumerate(outreps):
    #print(rep)
    plt.plot(aziA[i,:], ziA[i,:]/max(ziA[i,:]), '', label=str(freqs[i])+' GHz', lw=3)
...
for i, rep in enumerate(outreps):
    #print(rep)
    plt.plot(aziA[i,:], ziA[i,:]/max(ziA[i,:]), '', label=str(freqs[i])+' GHz', lw=3, alpha=0.5)
...
plt.plot(aziA[2,:], ziA[2,:]/max(ziA[2,:]), '', color='xkcd:bluish green', 
...
plt.plot(aziA[2,:], ziA[2,:]/max(ziA[2,:]), marker='x', ls='-', mew=2.5,
