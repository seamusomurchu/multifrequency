...
#MINE
plt.plot(azi, zin/(400*4*np.pi), color='#ff7f0e', label="Frequency Model Cut", lw=4)

# #DAVE
plt.plot(aziDAVE, zinDAVE/(400*4*np.pi), ':', color='#2ca02c', label="MODAL Model Cut", lw=3)

#donny
plt.plot(aziDONNY, zinDONNY/(400*4*np.pi), '-.', color='#d62728', label="SCATTER Model Cut", lw=2)

"""now plot single horn envelopes h113"""
plt.plot(aziA[1], ziA[1], label="Gaussian Envelope Horn 113", lw=2)
plt.plot(aziA[2], ziA[2], label="Freq Model Envelope Horn 113", lw=2)
plt.plot(aziA[3], ziA[3], ':', label="MODAL Model Envelope Horn 113", lw=2)
plt.plot(aziA[4], ziA[4], '-.', label="SCATTER Model Envelope Horn 113", lw=2)
...
plt.tight_layout()
#plt.savefig("/home/james/OneDrive/Thesis/Figures/figsc35/singlehorncutexample.png", bbox_inches='tight', facecolor='white')
```
