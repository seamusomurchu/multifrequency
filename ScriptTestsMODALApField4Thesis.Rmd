...
plt.tight_layout()
#plt.savefig("/home/james/OneDrive/ThesisPlots/spherical3x1zoom.png", bbox_inches='tight', facecolor='white')
```
...
plt.subplot(2,2,1)
plt.scatter(mysource[2,:], mysource[3,:], c=mysource[4,:])
plt.title('Amplitude (co-polar)')
plt.colorbar(label='dB')
plt.xlabel('Aperture Field X (mm)')
plt.ylabel('Aperture Field Y (mm)')
plt.xlim(min(mysource[2,:]), max(mysource[2,:]))
plt.ylim(min(mysource[3,:]), max(mysource[3,:]))

plt.subplot(2,2,2)
plt.scatter(mysource[2,:], mysource[3,:], c=mysource[5,:])
plt.title('Phase (co-polar)')
...
plt.subplot(2,2,3)
plt.scatter(mysource[2,:], mysource[3,:], c=mysource[6,:])
plt.title('Amplitude (cross-polar)')
plt.colorbar(label='dB')
plt.xlabel('Aperture Field X (mm)')
plt.ylabel('Aperture Field Y (mm)')
plt.xlim(min(mysource[2,:]), max(mysource[2,:]))
...
#plt.savefig("/home/james/OneDrive/Thesisv2/Figures/figsc35/modalapfieldexample3.png", bbox_inches='tight', facecolor='white')
```
...
qbrep = '/media/james/DATA/GRASPdata/MyTabSourceFIModel/150GHz/MODALfiles/'
...
#plt.savefig("/home/james/OneDrive/Thesisv2/Figures/figsc35/2x2FPv2.png", bbox_inches='tight', facecolor='white')
...
grep = '/media/james/DATA/GRASPdata/MyTabSourceFIModel/Gaussian150GHz/GRASPfiles/'
...
#donny
plt.plot(aziDONNY, zinDONNY, '-.', color='#ff7f0e', label="SCATTER Model Cut", lw=2)
...
plt.plot(aziGAUSS, zinGAUSS, label="Gaussian Cut", lw=4)
#donny
plt.plot(aziDONNY, zinDONNY, color='#ff7f0e', label="SCATTER Cut", lw=3)
#MINE
#plt.plot(azi, zin, color='#ff7f0e', label="MODAL Cut (frequency model)", lw=4)
# plt.plot(azi[peaks], zin[peaks], "x", label="Peaks", mew=5, ms=10)
# plt.plot(azi[peaks], results_half_n[1], '_', mew=5, ms=10, 
#      label="fwhm label {:3.3}".format(results_half_n[0][1]*0.12/301))
# plt.plot(azi[peaks], zin[peaks], "x", mew=5, ms=10,
...
#DAVE
plt.plot(aziDAVE, zinDAVE, ':', color='#2ca02c', label="MODAL Cut", lw=2)
# plt.plot(aziDAVE[peaksDAVE], zinDAVE[peaksDAVE], "x", label="Peaks", mew=5, ms=10)
# plt.plot(aziDAVE[peaksDAVE], results_half_n_DAVE[1], '_', mew=5, ms=10, 
#      label="fwhm label {:3.3}".format(results_half_n_DAVE[0][1]*0.12/301))
# plt.plot(aziDAVE[peaksDAVE], zinDAVE[peaksDAVE], "x", mew=5, ms=10,
...
#          format(aziDAVE[peaksDAVE][1]-aziDAVE[peaksDAVE][0], aziDAVE[peaksDAVE][1]-aziDAVE[peaksDAVE][2]))
#MINE
plt.plot(azi, zin, '-.', color='#d62728', label="MODAL Cut (frequency model)", lw=2)
# plt.plot(azi[peaks], zin[peaks], "x", label="Peaks", mew=5, ms=10)
# plt.plot(azi[peaks], results_half_n[1], '_', mew=5, ms=10, 
#      label="fwhm label {:3.3}".format(results_half_n[0][1]*0.12/301))
# plt.plot(azi[peaks], zin[peaks], "x", mew=5, ms=10,
...
#donny
#plt.plot(aziDONNY, zinDONNY, '-.', color='#ff7f0e', label="SCATTER Cut", lw=2)
#plt.plot(aziDONNY[peaksDONNY], zinDONNY[peaksDONNY], "x", label="Peaks", mew=5, ms=10)
#plt.plot(aziDONNY[peaksDONNY], results_half_n_DONNY[1], '_', mew=5, ms=10, 
     #label="fwhm label {:3.3}".format(results_half_n_DONNY[0][1]*0.12/301))
#plt.plot(aziDONNY[peaksDONNY], zinDONNY[peaksDONNY], "x", mew=5, ms=10,
...
plt.grid(True)
plt.yscale('log')
#plt.savefig("/home/james/OneDrive/Thesisv2/Figures/figsc35/fpcutplacehold2.png", bbox_inches='tight', facecolor='white')
```
...
plt.figure(figsize=(16,8))
#keep blue for gaussian...
plt.plot(aziGAUSS, ziGAUSS, label="Gaussian Cut", lw=4)
#donny
plt.plot(aziDONNY, ziDONNY, color='#ff7f0e', label="SCATTER Cut", lw=3)
#MINE


#DAVE
plt.plot(aziDAVE, ziDAVE, ':', color='#2ca02c', label="MODAL Cut", lw=2)

#MINE
plt.plot(azi, zi, '-.', color='#d62728', label="MODAL Cut (frequency model)", lw=2)
...
for rep in reps:
    ...
    file = rep+'FP_planar_grid_horn'+str(horn3)+'_150_GHz_Mstyle.qb'
    print(file)
...
for rep in reps:
    ...
    file = rep+'FP_planar_grid_horn'+str(horn4)+'_150_GHz_Mstyle.qb'
    print(file)
...
for rep in reps:
    ...
    file = rep+'FP_planar_grid_horn'+str(horn5)+'_150_GHz_Mstyle.qb'
    print(file)
...
plt.figure(figsize=(16,12))
#keep blue for gaussian...
plt.plot(aziGAUSS, zinGAUSS/(400*4*np.pi)*1.2, label="Gaussian Cut", lw=4)
#donny
plt.plot(aziDONNY, zinDONNY/(400*4*np.pi)*1.2, ':', color='#ff7f0e', label="SCATTER Cut", lw=4)
# #DAVE
plt.plot(aziDAVE, zinDAVE/(400*4*np.pi)*1.2, color='#2ca02c', label="MODAL Cut", lw=3)
#MINE
plt.plot(azi, zin/(400*4*np.pi)*1.2, '-.', color='#d62728', label="MODAL (frequency model) Cut", lw=3)


"""now plot single horn envelopes h113"""
plt.plot(aziA[1], ziA[1], color='forestgreen', label="Gaussian Envelope Horn 113", lw=3)
plt.plot(aziA[4], ziA[4], ':', color='mediumorchid', label="SCATTER Model Envelope Horn 113", lw=4)
plt.plot(aziA[3], ziA[3], color='cornflowerblue', label="MODAL Model Envelope Horn 113", lw=3)
plt.plot(aziA[2], ziA[2], '-.',  color='springgreen', label="Frequency Model Envelope Horn 113", lw=3)



"""now plot single horn envelopes h190"""
plt.plot(aziA[5], ziA[5], label="Gaussian Envelope Horn 190", lw=3)
plt.plot(aziA[8], ziA[8], ':', label="SCATTER Model Envelope Horn 190", lw=3)
plt.plot(aziA[7], ziA[7], label="MODAL Model Envelope Horn 190", lw=3)
plt.plot(aziA[6], ziA[6], '-.', label="Frequency Model Envelope Horn 190", lw=3)



# """now plot single horn envelopes h288"""
# # plt.plot(aziA[9], ziA[9], label="Gaussian Envelope Horn h288", lw=2)
# plt.plot(aziA[10], ziA[10], label="Freq Model Envelope Horn h288", lw=2)
# # plt.plot(aziA[11], ziA[11], ':', label="MODAL Model Envelope Horn h288", lw=2)
# # plt.plot(aziA[12], ziA[12], '-.', label="SCATTER Model Envelope Horn h288", lw=2)

# """now plot single horn envelopes h36"""
# # plt.plot(aziA[13], ziA[13], label="Gaussian Envelope Horn 36", lw=2)
# plt.plot(aziA[14], ziA[14], label="Freq Model Envelope Horn 36", lw=2)
# plt.plot(aziA[15], ziA[15], ':', label="MODAL Model Envelope Horn 36", lw=2)
# plt.plot(aziA[16], ziA[16], '-.', label="SCATTER Model Envelope Horn 36", lw=2)

# """now plot single horn envelopes 127"""
# # plt.plot(aziA[17], ziA[17], label="Gaussian Envelope Horn 127", lw=2)
# plt.plot(aziA[14], ziA[14], label="Freq Model Envelope Horn 127", lw=2)
# plt.plot(aziA[15], ziA[15], ':', label="MODAL Model Envelope Horn 127", lw=2)
# plt.plot(aziA[16], ziA[16], '-.', label="SCATTER Model Envelope Horn 127", lw=2)

plt.legend(loc='upper left', fontsize=15)
plt.xlabel('Focal Plane Cut (Radial) (m)')
plt.ylabel('Intensity (W)')
plt.title('Single Horns and FI Horns')
plt.grid(True)
#plt.yscale('log')
#plt.savefig("/home/james/OneDrive/Thesisv2/Figures/figsc35/singlehornsFPv2.png", bbox_inches='tight', facecolor='white')
print(max(ziA[7]), max(ziA[6]), max(ziA[7]) - max(ziA[6]))
```

```{python}
mesh = np.zeros([1, meshsize, meshsize])
mesh = makemeshgrid(np.array([dat['Xpos'], dat['Ypos'], GI]), meshsize)
...
plt.xlabel('Focal Plane X (m)')
plt.ylabel('Focal Plane Y (m)')
plt.title('Single Horn Cut')
#plt.colorbar()
#plt.axis('equal')

plt.tight_layout()
#plt.savefig("/home/james/OneDrive/Thesisv2/Figures/figsc35/singlehorncutexample.png", bbox_inches='tight', facecolor='white')
```
...
plt.plot([10.8, 10.8], [-50, -30], '--', color='grey')
...
plt.tight_layout()
#plt.savefig("/home/james/OneDrive/Thesisv2/Figures/figsc35/spherical3x1ZOOM.png", bbox_inches='tight', facecolor='white')
```

```{python}
print(gauscut[1,:], max(gauscut[1,:]), gauscut[1,:]+max(gauscut[1,:])*-1)
```
...
#gaussian
plt.plot(gauscut[0,:], gauscut[1,:]+max(gauscut[1,:])*-1, label='Gaussian model', linewidth=3)
#0deg
plt.plot(scat0deg[0,:], scat0deg[1,:]+max(scat0deg[1,:])*-1, label=r'Scatter 0$\degree$ cut', linewidth=3)
plt.plot(modal0deg[0,:], modal0deg[1,:]+max(modal0deg[1,:])*-1, label=r'MODAL 0$\degree$ cut', linewidth=3)
plt.plot(mymodal0deg[0,:], mymodal0deg[1,:]+max(mymodal0deg[1,:])*-1, label=r'MODAL 0$\degree$ cut (frequency model)', linewidth=3)

plt.plot([10.8, 10.8], [1, -20], '--', color='grey', lw=3, label='Focal Plane Limit')

plt.legend(loc='lower left')
plt.yticks(np.linspace(-10,-5, 11))
plt.grid(True)
plt.ylabel("Normalised Intenisty (dB)")
plt.xlabel(r'Angle $\theta$ ($^\circ$)')
#plt.title('Source Comparison 200 mm Spherical 0$\degree$ Cut')
...
plt.plot(gauscut[0,:], gauscut[1,:]+max(gauscut[1,:])*-1, label='Gaussian model', linewidth=3)
#45deg
plt.plot(scat45deg[0,:], scat45deg[1,:]+max(scat45deg[1,:])*-1, label=r'Scatter 45$\degree$ cut', linewidth=3)
plt.plot(modal45deg[0,:], modal45deg[1,:]+max(modal45deg[1,:])*-1, label=r'MODAL 45$\degree$ cut', linewidth=3)
plt.plot(mymodal45deg[0,:], mymodal45deg[1,:]+max(mymodal45deg[1,:])*-1, label=r'MODAL 45$\degree$ cut (frequency model)', linewidth=3)
plt.plot([10.8, 10.8], [1, -20], '--', color='grey', lw=3, label='Focal Plane Limit')
plt.legend(loc='lower left')
...
#ycuts
#90deg
plt.plot(scat90deg[0,:], scat90deg[1,:]+max(scat90deg[1,:])*-1, label=r'Scatter 90$\degree$ cut', linewidth=3)
plt.plot(modal45deg[0,:], modal45deg[1,:]+max(modal45deg[1,:])*-1,label=r'MODAL 90$\degree$ cut', linewidth=3)
plt.plot(mymodal90deg[0,:], mymodal90deg[1,:]+max(mymodal90deg[1,:])*-1, label=r'MODAL 90$\degree$ cut (frequency model)', linewidth=3)
plt.plot([10.8, 10.8], [1, -20], '--', color='grey', lw=3, label='Focal Plane Limit')
plt.legend(loc='lower left')
plt.grid(True)
plt.ylabel("Normalised Intenisty (dB)")
...
plt.tight_layout()
#plt.savefig("/home/james/OneDrive/Thesisv2/Figures/figsc35/spherical3x1ZOOMv2.png", bbox_inches='tight', facecolor='white')
```

```{python}
"""redo this strange plot"""
print(colors)

plt.figure(figsize=(16,12))
#keep blue for gaussian...
plt.plot(aziGAUSS, zinGAUSS/max(zinGAUSS), label="Gaussian Cut 400 Beams", lw=4)
#donny
plt.plot(aziDONNY, zinDONNY/max(zinDONNY), ':', color='#ff7f0e', label="SCATTER Cut 400 Beams", lw=4)
# #DAVE
plt.plot(aziDAVE, zinDAVE/max(zinDAVE), color='#2ca02c', label="MODAL Cut 400 Beams", lw=3)
#MINE
plt.plot(azi, zin/max(zin), '-.', color='#d62728', label="MODAL (frequency model) Cut 400 Beams", lw=3)


"""now plot single horn envelopes h113"""
plt.plot(aziA[1], ziA[1]/max(ziA[1]), color='forestgreen', label="Gaussian Envelope Horn 113", lw=3)
plt.plot(aziA[4], ziA[4]/max(ziA[4]), ':', color='mediumorchid', label="SCATTER Model Envelope Horn 113", lw=4)
plt.plot(aziA[3], ziA[3]/max(ziA[3]), color='cornflowerblue', label="MODAL Model Envelope Horn 113", lw=3)
plt.plot(aziA[2], ziA[2]/max(ziA[2]), '-.',  color='springgreen', label="Frequency Model Envelope Horn 113", lw=3)



"""now plot single horn envelopes h190"""
plt.plot(aziA[5], ziA[5]/max(ziA[5]), label="Gaussian Envelope Horn 190", lw=3)
plt.plot(aziA[8], ziA[8]/max(ziA[8]), ':', label="SCATTER Model Envelope Horn 190", lw=3)
plt.plot(aziA[7], ziA[7]/max(ziA[7]), label="MODAL Model Envelope Horn 190", lw=3)
plt.plot(aziA[6], ziA[6]/max(ziA[6]), '-.', label="Frequency Model Envelope Horn 190", lw=3)
...
plt.grid(True)
#plt.yscale('log')
#plt.savefig("/home/james/OneDrive/Thesisv2/Figures/figsc35/singlehornsFPv3.png", bbox_inches='tight', facecolor='white')
print(max(ziA[7]), max(ziA[6]), max(ziA[7]) - max(ziA[6]))
```
