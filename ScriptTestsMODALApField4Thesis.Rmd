...
"""now plot single horn envelopes h113"""
plt.plot(aziA[1], ziA[1]/max(ziA[1]), color='forestgreen', label="Gaussian Horn 113", lw=3)
plt.plot(aziA[4], ziA[4]/max(ziA[4]), ':', color='mediumorchid', label="SCATTER Model Horn 113", lw=4)
plt.plot(aziA[3], ziA[3]/max(ziA[3]), color='cornflowerblue', label="MODAL Model Horn 113", lw=3)
plt.plot(aziA[2], ziA[2]/max(ziA[2]), '-.',  color='springgreen', label="Frequency Model Horn 113", lw=3)



"""now plot single horn envelopes h190"""
plt.plot(aziA[5], ziA[5]/max(ziA[5]), label="Gaussian Horn 190", lw=3)
plt.plot(aziA[8], ziA[8]/max(ziA[8]), ':', label="SCATTER Model Horn 190", lw=3)
plt.plot(aziA[7], ziA[7]/max(ziA[7]), label="MODAL Model Horn 190", lw=3)
plt.plot(aziA[6], ziA[6]/max(ziA[6]), '-.', label="Frequency Model Horn 190", lw=3)
...
plt.xticks(np.linspace(-0.06,0.05,25), fontsize=8)
plt.grid(True)
#plt.yscale('log')
#plt.savefig("/home/james/OneDrive/Thesisv3_revised_layout/Figures/figshornap/singlehornsFPv4.png", bbox_inches='tight', facecolor='white')
#print(max(ziA[7]), max(ziA[6]), max(ziA[7]) - max(ziA[6]))
```
