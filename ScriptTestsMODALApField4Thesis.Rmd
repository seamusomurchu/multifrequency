...
plt.figure(figsize=(16,12))
#keep blue for gaussian...
plt.plot(aziGAUSS, zinGAUSS/(400*4*np.pi), label="Gaussian Cut", lw=4)
#donny
plt.plot(aziDONNY, zinDONNY/(400*4*np.pi), ':', color='#ff7f0e', label="SCATTER Cut", lw=4)
# #DAVE
plt.plot(aziDAVE, zinDAVE/(400*4*np.pi), color='#2ca02c', label="MODAL Cut", lw=3)
#MINE
plt.plot(azi, zin/(400*4*np.pi), '-.', color='#d62728', label="MODAL (frequency model) Cut", lw=3)
...
plt.grid(True)
#plt.yscale('log')
#plt.savefig("/home/james/OneDrive/Thesisv2/Figures/figsc35/singlehornsFP.png", bbox_inches='tight', facecolor='white')
