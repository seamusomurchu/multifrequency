...
d.read_from_file(path+'pipeline_demo.dict')
...
ax[0].plot(th_deg, allbeams[1],'--', c = plt.cm.jet(np.linspace(0,1,6))[::-1][3],
           label=r'${:.2f}~$GHz'.format(freqs[1]/1e9))
ax[0].plot(th_deg, allbeams[2],'--', c = plt.cm.jet(np.linspace(0,1,6))[::-1][5],
           label=r'${:.2f}~$GHz'.format(freqs[2]/1e9))
...
ax[0].plot(th_deg, allbeams[1]*sb_noprim(th_deg, freqs[1],0),
           c = plt.cm.jet(np.linspace(0,1,6))[::-1][3],
           label=None, lw=2)
ax[0].plot(th_deg, allbeams[2]*sb_noprim(th_deg, freqs[2],0),
           c = plt.cm.jet(np.linspace(0,1,6))[::-1][5],
           label=None, lw=2)
...
print(colors)
"""ask louise - I just want to say those synth beam scripts a great! Do you know what the units of the beams are? dB or Watts?"""
```
...
plt.plot(th_deg, allbeams[0],'--', c='#1f77b4',
           label=r'${:.2f}~$GHz'.format(freqs[0]/1e9))
plt.plot(th_deg, allbeams[1],'--', c='#ff7f0e',
           label=r'${:.2f}~$GHz'.format(freqs[1]/1e9))
plt.plot(th_deg, allbeams[2],'--', c='#2ca02c',
           label=r'${:.2f}~$GHz'.format(freqs[2]/1e9))

plt.plot(th_deg, allbeams[0]*sb_noprim(th_deg, freqs[0],0), c='#1f77b4',
           label=None, lw=2)
plt.plot(th_deg, allbeams[1]*sb_noprim(th_deg, freqs[1],0), c='#ff7f0e',
           label=None, lw=2)
plt.plot(th_deg, allbeams[2]*sb_noprim(th_deg, freqs[2],0), c='#2ca02c',
           label=None, lw=2)

plt.legend(loc='upper right')
plt.ylabel("Intenisty")
plt.xlabel(r'Angle $\theta$ ($^\circ$)')
#plt.savefig("/home/james/OneDrive/Thesisv2/Figures/figsc6/synthfreqsnew.png", bbox_inches='tight', facecolor='white')
```
