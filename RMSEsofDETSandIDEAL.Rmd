...
#plt.savefig('/home/james/OneDrive/Thesisv4/Figures/figs_baselines/polardets.png', facecolor='white')
```
...
norm = mpl.colors.Normalize(vmin=0, vmax=max(rmsesm))
fig.colorbar(mpl.cm.ScalarMappable(norm=norm, cmap='jet'),
             cax=None, orientation='vertical', label='Mean RMSE of Baseline Type', ticks=np.linspace(0,0.5,6), 
             shrink=.5, pad=0.05)
plt.tight_layout()
ax.set_rscale('symlog')
#ax.legend()
#print(label_position)
#plt.savefig('/home/james/OneDrive/Thesisv4/Figures/figs_baselines/polarFIidealcomp.png', facecolor='white')
```
...
norm = mpl.colors.Normalize(vmin=0, vmax=max(rmsesm))
fig.colorbar(mpl.cm.ScalarMappable(norm=norm, cmap='jet'),
             cax=None, orientation='vertical', label='Mean RMSE of Baseline Types', ticks=np.linspace(0,0.06,5), 
             shrink=.6, pad=0.05)
plt.tight_layout()
ax.set_rscale('symlog')
#plt.savefig('/home/james/OneDrive/Thesisv4/Figures/figs_baselines/rmseofBLtype_TD_polar.png', facecolor='white')
