...
plt.plot(bins2[0:101],histogramEQ/max(histogramEQ), color='xkcd:sea green', 
         label='Arbitrary Baselines {}{}'.format(fipair1EQ, fipair2EQ), lw=3)

plt.plot(binsARB[0:101],histogramARB/max(histogramARB),  color='xkcd:burnt orange', 
         label='Equivalent Baselines {}{}'.format(fipair1ARB, fipair2ARB), lw=3)

plt.xlabel('Residual Difference (W)')
plt.ylabel('Frequency')
plt.legend(loc='upper right')
#plt.show()
#plt.savefig('/home/james/OneDrive/Thesisv4/Figures/figs_baselines/residcomp_hist.png', dpi=300, facecolor='w')
```
...
histogramEQ, binsEQ = np.histogram(diffEQ, bins=101, range=(-1, 1), density=False)
histogramf, binsf = np.histogram(difff, bins=101, range=(-1, 1), density=False)
# histogram, bins = np.histogram(diff, bins=25, range=(-maxd2, maxd2), density=True)
# histogram2, bins2 = np.histogram(diff2, bins=25, range=(-maxd2, maxd2), density=True)
histogramARB, binsARB, = np.histogram(diffARB, bins=101, range=(-1, 1), density=False)
...
plt.rc('font', **font)
plt.figure(figsize=(16, 8))
plt.plot(binsEQ[0:101],histogramEQ/max(histogramEQ), color='xkcd:sea green', 
         label='Close Baselines {}{}'.format(fipair1EQ, fipair2EQ), lw=3)
plt.plot(binsf[0:101],histogramf/max(histogramf),  color='xkcd:cobalt', 
