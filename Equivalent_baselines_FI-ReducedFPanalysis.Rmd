...
#plt.savefig('/media/james/DATA/baseline_figures/results_cb_all_FI_v2.png', facecolor='white')
...
#plt.savefig('/media/james/DATA/baseline_figures/results_cb_meanstd_FI_full_v2.png', facecolor='white')
font = {'family' : 'normal',
        'weight' : 'normal',
        'size'   : 20}
plt.rc('font', **font)
...
plt.ylabel('Distance Between Horns')
plt.xlabel(r'Angular Orientation ($\theta$)')
#polarFI2meanrmseplt.savefig('/home/james/OneDrive/Thesisv4/Figures/figs_baselines/rmseofBLtype_v3.png', facecolor='white')
...
#ax.legend()
#print(label_position)
#plt.savefig('/home/james/OneDrive/Thesisv4/Figures/figs_baselines/polarFI_v2.png', facecolor='white')
```
