...
for i in range(len(partitioned_baselines)):
    ...
    for j in range(n_angles):
        #print(len(partitioned_baselines[i][j][:,0]))
...
plt.colorbar(mpl.cm.ScalarMappable(norm=norm, cmap=cmap),
             cax=None, orientation='vertical', label='Some Units', ticks=np.linspace(0,378,15))
...
plt.colorbar(mpl.cm.ScalarMappable(norm=norm, cmap=cmap),
             cax=None, orientation='vertical', label='Some Units')
