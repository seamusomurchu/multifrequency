...
for i in range(len(centers)):
        ...
        #plt.text(centers[i,0]-0.006, centers[i,1], 'c{0:}'.format(col[i]), color='r',fontsize=8)
        #plt.text(centers[i,0]+0.00001, centers[i,1], 'r{0:}'.format(row[i]), color='b',fontsize=8)
    if centers[i,0] > XMIN and centers[i,0] < XMAX and centers[i,1] > YMIN and centers[i,1] < YMAX:
        plt.text(centers[i,0]-0.005, centers[i,1], '{}, {}'.format(q.horn.row[i], q.horn.column[i]), color='r',fontsize=12)

    #plt.text(centers[i,0]-0.005, centers[i,1]-0.004, '{0:.1f}'.format(centers[i,1]*1000), color='r',fontsize=8)
        plt.text(centers[i,0]-0.005, centers[i,1]-0.004, 'H {0:}'.format(str(i+1)), color='g',fontsize=12)
    #plt.text(centers[i,0]-0.005, centers[i,1], 'td {0:}'.format(str(cnt)), color='r',fontsize=8)
...
plt.xlabel('Horn GRF X (m)')
plt.show()
plt.savefig("/home/james/OneDrive/Thesisv4/Figures/figs_baselines/hornlayoutquart.png", bbox_inches='tight', facecolor='white')
```
...
for i in range(N):
    ...
    for j in range(i+1,N):
        ...
        baseline_v2.append([x_j,y_j, L2, angle])
...
c = ax.scatter(theta, L2, c=nbl, s=65, cmap='jet', alpha=0.75)
...
#plt.savefig('/home/james/OneDrive/Thesisv4/Figures/figs_baselines/polarFInBLs.png', facecolor='white')
