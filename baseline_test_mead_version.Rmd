...
baseline_plotter(x, y, p1i, p2i, abs(diff), TDhornsFIconf, tdpair1, tdpair2, centers, virtual_diff=True)
```
...
#initialise file
file = open("/home/james/mylibs/multifrequency/baseline_files/baseline_type1_OUT.txt", "w")
file.write("index, pair1, pair2, sum(abs(diff))"+'\n')
...
#           btype[int(buildar[i,1]),1], btype[int(buildar[i,1]),2])
    ...
    plt.savefig('/media/james/DATA/baseline_figures/TYPE1/'+str(pair)+'.png')

    file.write("{}, {}, {}, {}, {}".format(i, btype[int(buildar[i,0]),1], btype[int(buildar[i,0]),2], 
               btype[int(buildar[i,1]),1], btype[int(buildar[i,1]),2]) +', '+str(sum(abs(diff))/len(diff))+'\n')
    
    print(buildar[i,0], buildar[i,1], btype[int(buildar[i,0]),1:3], btype[int(buildar[i,1]),1:3], 
          "diff, ", sum(abs(diff))/len(diff))
...
#initialise file
file = open("/home/james/mylibs/multifrequency/baseline_files/baseline_type2_OUT.txt", "w")
file.write("index, pair1, pair2, sum(abs(diff))"+'\n')
...
#           btype[int(buildar[i,1]),1], btype[int(buildar[i,1]),2])
    ...
    plt.savefig('/media/james/DATA/baseline_figures/TYPE2/'+str(pair)+'.png')
...
#initialise file
file = open("/home/james/mylibs/multifrequency/baseline_files/baseline_type3_OUT.txt", "w")
file.write("index, pair1, pair2, sum(abs(diff))"+'\n')
...
#initialise file
file = open("/home/james/mylibs/multifrequency/baseline_files/baseline_type4_OUT.txt", "w")
file.write("index, pair1, pair2, sum(abs(diff))"+'\n')
...
btype = np.loadtxt('/home/james/mylibs/multifrequency/baseline_files/baseline_JCLtype1.txt', 
                   skiprows=1, delimiter=',', dtype=int)
print("baseline tJCLtype1 file shapes, ", btype.shape, btype[0,:])
print(btype)
bi = np.linspace(0, len(btype[:,0])-1, len(btype[:,0]), dtype=int)
print(bi)
comb = combinations(bi, 2)
...
#initialise file
file = open("/home/james/mylibs/multifrequency/baseline_files/baseline_JCLtype1_OUT.txt", "w")
file.write("index, pair1, pair2, sum(abs(diff))"+'\n')
...
#initialise file
file = open("/home/james/mylibs/multifrequency/baseline_files/baseline_lessgood_type1_OUT.txt", "w")
file.write("index, pair1, pair2, sum(abs(diff))"+'\n')
...
#initialise file
file = open("/home/james/mylibs/multifrequency/baseline_files/baseline_lessgood_type2_OUT.txt", "w")
file.write("index, pair1, pair2, sum(abs(diff))"+'\n')
...
#           btype[int(buildar[i,1]),1], btype[int(buildar[i,1]),2])
    ...
    plt.savefig('/media/james/DATA/baseline_figures/LG2/'+str(pair)+'.png')
...
```{python}
rep = '/home/james/mylibs/multifrequency/baseline_files/'
...
cjltype1dat = np.loadtxt('/home/james/mylibs/multifrequency/baseline_files/baseline_JCLtype1_OUT.txt',
                         delimiter=', ', skiprows=1).T
LG1dat = np.loadtxt('/home/james/mylibs/multifrequency/baseline_files/baseline_lessgood_type1_OUT.txt',
                         delimiter=', ', skiprows=1).T
LG2dat = np.loadtxt('/home/james/mylibs/multifrequency/baseline_files/baseline_lessgood_type2_OUT.txt',
                         delimiter=', ', skiprows=1).T
t1dat = np.loadtxt('/home/james/mylibs/multifrequency/baseline_files/baseline_type1_OUT.txt',
                         delimiter=', ', skiprows=1).T
t2dat = np.loadtxt('/home/james/mylibs/multifrequency/baseline_files/baseline_type2_OUT.txt',
                         delimiter=', ', skiprows=1).T
t3dat = np.loadtxt('/home/james/mylibs/multifrequency/baseline_files/baseline_type3_OUT.txt',
                         delimiter=', ', skiprows=1).T
t4dat = np.loadtxt('/home/james/mylibs/multifrequency/baseline_files/baseline_type4_OUT.txt',
                         delimiter=', ', skiprows=1).T
```
...
plt.ylabel('Residual Difference Between Baselines')

plt.savefig('/media/james/DATA/baseline_figures/results.png')
